          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://www.youtube.com/@NirmaanEducation" target="_blank" rel="noopener noreferrer" aria-label="Youtube" className="w-12 h-12 bg-red-500 text-white rounded-lg flex items-center justify-center transition-transform hover:scale-110 shadow-md">
                  <Youtube />
                </a>

                <a href="https://www.linkedin.com/company/nirmaan-education/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-12 h-12 bg-blue-600 text-white rounded-lg flex items-center justify-center transition-transform hover:scale-110 shadow-md">
                  <Linkedin />
                </a>

                <a href="https://wa.me/918431234711" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="w-12 h-12 bg-green-500 text-white rounded-lg flex items-center justify-center transition-transform hover:scale-110 shadow-md">
                  <MessageSquare />
                </a>

                <a href="https://t.me/nirmaan_education" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="w-12 h-12 bg-sky-500 text-white rounded-lg flex items-center justify-center transition-transform hover:scale-110 shadow-md">
                  <TelegramIcon />
                </a>
              </div>
