...
const HoverSkillCard = ({ image, title, description, icon, features, tagline }) => ( // Added tagline prop
  <div className="group relative w-full max-w-sm h-[500px] bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-500 ease-in-out transform hover:scale-105 hover:shadow-2xl">
      ...
      <div className="relative h-full p-6 flex flex-col justify-end text-white text-left">
          ...
          <div className="absolute bottom-0 left-0 w-full p-6 transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100 transform translate-y-10 group-hover:translate-y-0">
              ...
              {/* NEW: Added the orange tagline as requested */}
              <h4 
                  className="mb-4"
                  style={{
                      ...
                      fontSize: '25px',
                      lineHeight: '30px',
                      color: '#FC6B2D', // Orange color
                      opacity: 0.9 // Set opacity (0.7 was a bit low on dark bg)
                  }}
              >
                  {tagline}
              </h4>
...
const programData = [
{
  ...
  description: "Students who think clearly, express ideas effectively, and communicate with confidence grow into strong, influential leaders — ready to stand out in school, career, and life.",
  ...
  image: commImage,
  tagline: "Because confident communication builds future leaders." // NEW Tagline
},
{
  title: "Life Skills",
  description: "Regardless of marks or scores, these essential life skills enable every student to thrive in their career and live a happier, more meaningful life — with emotional intelligence, empathy, and resilience at the core.",
  ...
  image: lifeImage,
  tagline: "Grades show performance. Life skills build character." // NEW Tagline
},
{
  title: "21st Century Skills",
  description: "In this fast-changing world, students who are critical thinkers, problem-solvers, and innovators equipped with next-gen technology gain an edge in every field of the future.",
  ...
  image: skillsImage,
  tagline: "The world rewards those who can think, solve, and innovate." // NEW Tagline
},
];
...
<section id="programs" className="relative py-20 lg:py-32 bg-[#FFF8F1] scroll-mt-16 overflow-hidden">
  ...
  <div className="relative max-w-[1400px] mx-auto px-4 text-center z-10">
    ...
    <div className="flex flex-col md:flex-row flex-wrap gap-8 justify-center items-stretch">
      {/* Pass all props, including the new tagline, to the card */}
